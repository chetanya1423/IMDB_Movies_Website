    ...
    export const UpCommingMain =({movie,index}) => {
      ...
      <Link to={`/upCommingMovieDetail/${movie.titleText.text}`}>
    <div className={`flex flex-col un-main-searchcard `} >
          <div className='w-[200px] h-[294px] bg-contain bg-no-repeat bg-center  multiImage' style={{ backgroundImage: `url('${movie.primaryImage.url}')` }}>
