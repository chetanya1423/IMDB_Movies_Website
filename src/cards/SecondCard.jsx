  ...
  return (
    ...
    <div
      ...
      className="lg:min-w-[189px] md:min-w-[19%] sm:min-w-[26%]  max-h-full  rounded-xl card-main   items-center
                       ...
                       hover:z-0   duration-[0.5s] ease-in-out  shadow-2xl block z-5 popular-main-card " 
                       onClick={addToCard} >
    <Link to={`/detail`}>
<div className={`un-popular-main-card `} >
       
          <div className='lg:w-[189px] lg:h-[276px] md:w-[137px] md:h-[202px] sm:w-[152px] sm:h-[225px] bg-center bg-contain bg-no-repeat popular-bg-img upcomming-bg multiImage'  style={{ backgroundImage: `url('${movie.image_url}')` }}>
       ...
       <div className='lg:w-[100%] md:w-[137px] sm:w-[153px] items-start flex flex-col space-y-2 p-2 gap-2 font-custom text-sm bg-shadowBlack second-card-content'>
